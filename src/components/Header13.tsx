...
const Header13 = () => {
    ...
    const [path, setPath] = useState('/youtube');
                    ...
                    <div className="main-bar clearfix">
                        <div className="container-fluid clearfix">
                            <div className="logo-header">
                                <Link to="/youtube"><img src={logo} alt="" /></Link>
                            </div>
                            <div className="extra-nav">
                                <div className="extra-cell">
                                    <ul>
                                        <li><Link to="/contact-us-youtube"><span>Contact us?</span></Link></li>
                                        <li onClick={() => {
                            ...
                            <div className={`header-nav icon-menu ${addActive === true ? 'active' : ''}`}>
                                <ul className="nav navbar-nav">
                                    <li onClick={pathBtn} className={`${path === '/youtube' && 'active'}`}><Link to="youtube"><i className="ti-home"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/about-us-youtube' && 'active'}`}><Link to="about-us-youtube"><i className="ti-info-alt"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/resume-youtube' && 'active'}`}><Link to="resume-youtube"><i className="ti-user"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/portfolio-youtube' && 'active'}`}><Link to="portfolio-youtube"><i className="ti-layout-grid2"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/contact-us-youtube' && 'active'}`}><Link to="contact-us-youtube"><i className="ti-headphone-alt"></i></Link></li>
