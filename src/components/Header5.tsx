...
const Header5 = () => {
    ...
    const [path, setPath] = useState('/security');
                    ...
                    <div className="main-bar clearfix">
                        <div className="container-fluid clearfix">
                            <div className="logo-header">
                                <Link to="/security"><img src={logo} alt="" /></Link>
                            </div>
                            <div className="extra-nav">
                                <div className="extra-cell">
                                    <ul>
                                        <li><Link to="/contact-us-security"><span>Contact us?</span></Link></li>
                                        <li onClick={() => {
                            ...
                            <div className={`header-nav icon-menu ${addActive === true ? 'active' : ''}`}>
                                <ul className="nav navbar-nav">
                                    <li onClick={pathBtn} className={`${path === '/security' && 'active'}`}><Link to="security"><i className="ti-home"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/about-us-security' && 'active'}`}><Link to="about-us-security"><i className="ti-info-alt"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/resume-security' && 'active'}`}><Link to="resume-security"><i className="ti-user"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/portfolio-security' && 'active'}`}><Link to="portfolio-security"><i className="ti-layout-grid2"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/contact-us-security' && 'active'}`}><Link to="contact-us-security"><i className="ti-headphone-alt"></i></Link></li>
