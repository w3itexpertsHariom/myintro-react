                    ...
                    <div className="main-bar clearfix">
                        <div className="container-fluid clearfix">
                            <div className="logo-header">
                                <Link to="/modal"><img src={logo} alt="" /></Link>
                            </div>
                            <div className="extra-nav">
                                <div className="extra-cell">
                                    <ul>
                                        <li><Link to="/contact-us-modal"><span>Contact us?</span></Link></li>
                                        <li onClick={() => {
                            ...
                            <div className={`header-nav icon-menu ${addActive === true ? 'active' : ''}`}>
                                <ul className="nav navbar-nav">
                                    <li onClick={pathBtn} className={`${path === '/modal' && 'active'}`}><Link to="modal"><i className="ti-home"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/about-us-modal' && 'active'}`}><Link to="about-us-modal"><i className="ti-info-alt"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/resume-modal' && 'active'}`}><Link to="resume-modal"><i className="ti-user"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/portfolio-modal' && 'active'}`}><Link to="portfolio-modal"><i className="ti-layout-grid2"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/contact-us-modal' && 'active'}`}><Link to="contact-us-modal"><i className="ti-headphone-alt"></i></Link></li>
