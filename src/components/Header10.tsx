...
const Header10 = () => {
    ...
    const [path, setPath] = useState('/swimmer');
    ...
    useEffect(() => {
        ...
        if (window.location.pathname !=='/swimmer') {
                    ...
                    <div className="main-bar clearfix">
                        <div className="container-fluid clearfix">
                            <div className="logo-header">
                                <Link to="/swimmer"><img src={logo} alt="" /></Link>
                            </div>
                            <div className="extra-nav">
                                <div className="extra-cell">
                                    <ul>
                                        <li><Link to="/contact-us-swimmer"><span>Contact us?</span></Link></li>
                                        <li onClick={() => {
                            ...
                            <div className={`header-nav icon-menu ${addActive === true ? 'active' : ''}`}>
                                <ul className="nav navbar-nav">
                                    <li onClick={pathBtn} className={`${path === '/swimmer' && 'active'}`}><Link to="swimmer"><i className="ti-home"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/about-us-swimmer' && 'active'}`}><Link to="about-us-swimmer"><i className="ti-info-alt"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/resume-swimmer' && 'active'}`}><Link to="resume-swimmer"><i className="ti-user"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/portfolio-swimmer' && 'active'}`}><Link to="portfolio-swimmer"><i className="ti-layout-grid2"></i></Link></li>
                                    <li onClick={pathBtn} className={`${path === '/contact-us-swimmer' && 'active'}`}><Link to="contact-us-swimmer"><i className="ti-headphone-alt"></i></Link></li>
