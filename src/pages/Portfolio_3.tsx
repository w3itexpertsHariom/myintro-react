...
const imageGallery = [
    { img: IMAGE.galleryBrandModalPic1, categery: 'Creative' },
    { img: IMAGE.galleryBrandModalPic2, categery: 'Design' },
    { img: IMAGE.galleryBrandModalPic3, categery: 'Photography' },
    { img: IMAGE.galleryBrandModalPic4, categery: 'Design' },
    { img: IMAGE.galleryBrandModalPic5, categery: 'Photography' },
    { img: IMAGE.galleryBrandModalPic6, categery: 'Design' },
    { img: IMAGE.galleryBrandModalPic7, categery: 'Photography' },
    { img: IMAGE.galleryBrandModalPic8, categery: 'Design' },
    { img: IMAGE.galleryBrandModalPic9, categery: 'Photography' },
]
const Portfolio_3 = () => {
