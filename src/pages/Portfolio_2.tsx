...
const imageGallery = [
    { img: IMAGE.businessManPic1, categery: 'Creative' },
    { img: IMAGE.businessManPic2, categery: 'Design' },
    { img: IMAGE.businessManPic3, categery: 'Photography' },
    { img: IMAGE.businessManPic4, categery: 'Design' },
    { img: IMAGE.businessManPic5, categery: 'Photography' },
    { img: IMAGE.businessManPic6, categery: 'Design' },
    { img: IMAGE.businessManPic7, categery: 'Photography' },
    { img: IMAGE.businessManPic8, categery: 'Design' },
    { img: IMAGE.businessManPic9, categery: 'Photography' },
]
const Portfolio_2 = () => {
