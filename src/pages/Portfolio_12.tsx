...
const imageGallery = [
    { img: IMAGE.galleryNewsPic1, categery: 'Creative' },
    { img: IMAGE.galleryNewsPic2, categery: 'Design' },
    { img: IMAGE.galleryNewsPic3, categery: 'Photography' },
    { img: IMAGE.galleryNewsPic4, categery: 'Design' },
    { img: IMAGE.galleryNewsPic5, categery: 'Photography' },
    { img: IMAGE.galleryNewsPic6, categery: 'Design' },
    { img: IMAGE.galleryNewsPic7, categery: 'Photography' },
    { img: IMAGE.galleryNewsPic8, categery: 'Design' },
    { img: IMAGE.galleryNewsPic9, categery: 'Photography' },
]
const Portfolio_12 = () => {
