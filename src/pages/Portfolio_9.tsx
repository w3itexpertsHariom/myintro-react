...
const imageGallery = [
    { img: IMAGE.galleryCommanPic1, categery: 'Creative' },
    { img: IMAGE.galleryCommanPic2, categery: 'Design' },
    { img: IMAGE.galleryCommanPic3, categery: 'Photography' },
    { img: IMAGE.galleryCommanPic4, categery: 'Design' },
    { img: IMAGE.galleryCommanPic5, categery: 'Photography' },
    { img: IMAGE.galleryCommanPic6, categery: 'Design' },
    { img: IMAGE.galleryCommanPic7, categery: 'Photography' },
    { img: IMAGE.galleryCommanPic8, categery: 'Design' },
    { img: IMAGE.galleryCommanPic9, categery: 'Photography' },
]
const Portfolio_9 = () => {
