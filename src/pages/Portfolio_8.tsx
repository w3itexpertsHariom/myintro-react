...
const imageGallery = [
    { img: IMAGE.galleryBloggerPic1, categery: 'Creative' },
    { img: IMAGE.galleryBloggerPic2, categery: 'Design' },
    { img: IMAGE.galleryBloggerPic3, categery: 'Photography' },
    { img: IMAGE.galleryBloggerPic4, categery: 'Design' },
    { img: IMAGE.galleryBloggerPic5, categery: 'Photography' },
    { img: IMAGE.galleryBloggerPic6, categery: 'Design' },
    { img: IMAGE.galleryBloggerPic7, categery: 'Photography' },
    { img: IMAGE.galleryBloggerPic8, categery: 'Design' },
    { img: IMAGE.galleryBloggerPic9, categery: 'Photography' },
]
const Portfolio_8 = () => {
