...
const imageGallery = [
    { img: IMAGE.galleryGymPic1, categery: 'Creative' },
    { img: IMAGE.galleryGymPic2, categery: 'Design' },
    { img: IMAGE.galleryGymPic3, categery: 'Photography' },
    { img: IMAGE.galleryGymPic4, categery: 'Design' },
    { img: IMAGE.galleryGymPic5, categery: 'Photography' },
    { img: IMAGE.galleryGymPic6, categery: 'Design' },
    { img: IMAGE.galleryGymPic7, categery: 'Photography' },
    { img: IMAGE.galleryGymPic8, categery: 'Design' },
    { img: IMAGE.galleryGymPic9, categery: 'Photography' },
]
const Portfolio_6 = () => {
