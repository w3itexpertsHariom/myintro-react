...
const imageGallery = [
    { img: IMAGE.galleryElectricianPic1, categery: 'Creative' },
    { img: IMAGE.galleryElectricianPic2, categery: 'Design' },
    { img: IMAGE.galleryElectricianPic3, categery: 'Photography' },
    { img: IMAGE.galleryElectricianPic4, categery: 'Design' },
    { img: IMAGE.galleryElectricianPic5, categery: 'Photography' },
    { img: IMAGE.galleryElectricianPic6, categery: 'Design' },
    { img: IMAGE.galleryElectricianPic7, categery: 'Photography' },
    { img: IMAGE.galleryElectricianPic8, categery: 'Design' },
    { img: IMAGE.galleryElectricianPic9, categery: 'Photography' },
]
const Portfolio_7 = () => {
