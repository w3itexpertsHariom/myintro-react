...
const imageGallery = [
    { img: IMAGE.galleryDancePic1, categery: 'Creative' },
    { img: IMAGE.galleryDancePic2, categery: 'Design' },
    { img: IMAGE.galleryDancePic3, categery: 'Photography' },
    { img: IMAGE.galleryDancePic4, categery: 'Design' },
    { img: IMAGE.galleryDancePic5, categery: 'Photography' },
    { img: IMAGE.galleryDancePic6, categery: 'Design' },
    { img: IMAGE.galleryDancePic7, categery: 'Photography' },
    { img: IMAGE.galleryDancePic8, categery: 'Design' },
    { img: IMAGE.galleryDancePic9, categery: 'Photography' },
]
const Portfolio_11 = () => {
