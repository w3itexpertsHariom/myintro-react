...
const imageGallery = [
  { img: IMAGE.galleryofficerPic1, categery: 'Creative' },
  { img: IMAGE.galleryofficerPic2, categery: 'Design' },
  { img: IMAGE.galleryofficerPic3, categery: 'Photography' },
  { img: IMAGE.galleryofficerPic4, categery: 'Design' },
  { img: IMAGE.galleryofficerPic5, categery: 'Photography' },
  { img: IMAGE.galleryofficerPic6, categery: 'Design' },
  { img: IMAGE.galleryofficerPic7, categery: 'Photography' },
  { img: IMAGE.galleryofficerPic8, categery: 'Design' },
  { img: IMAGE.galleryofficerPic9, categery: 'Photography' },
]
const Portfolio_5 = () => {
