...
const imageGallery = [
    { img: IMAGE.galleryDoctorPic1, categery: 'Creative' },
    { img: IMAGE.galleryDoctorPic2, categery: 'Design' },
    { img: IMAGE.galleryDoctorPic3, categery: 'Photography' },
    { img: IMAGE.galleryDoctorPic4, categery: 'Design' },
    { img: IMAGE.galleryDoctorPic5, categery: 'Photography' },
    { img: IMAGE.galleryDoctorPic6, categery: 'Design' },
    { img: IMAGE.galleryDoctorPic7, categery: 'Photography' },
    { img: IMAGE.galleryDoctorPic8, categery: 'Design' },
    { img: IMAGE.galleryDoctorPic9, categery: 'Photography' },
]
const Portfolio_4 = () => {
